...
TOTPT solves time-optimal raceline for given track using NLP with direct collocation approach, and performs high-performance NMPC path tracking through racing scenario in Simulink.
